...
В любой разработке присутствуют ошибки. В каком-то смысле ошибки являются данностью процесса разработки, но той
данностью, которую необходимо минимизировать.  
...
От проекта, берущегося за основу, может зависеть скорость и качество не только самого старта, но и всего последующего
хода разработки.
