...
***Стартерами** называются, как правило, небольшие, заведомо работоспособные, лёгкие в установке и запуске проекты, имеющие
чётко определённый набор свойств, предназначенные для использования в качестве основы для новых разработок*.

В принципе преимущества использования стартеров очевидны, но всё-таки хотелось бы отметить одно, возможно наименее
очевидное.  

В любой разработке присутствуют ошибки. В каком-то смысле ошибки являются неотъемлемой частью, данностью процесса
разработки, которую необходимо минимизировать. В этом, кстати, состоит, наверное главная составляющая искусства
разработчика.  
...
потеря работоспособности программы становится сразу видна, особенно, если в проекте присутствуют автотесты.
