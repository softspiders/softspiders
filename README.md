...
Проект *[SoftSpiders](https://github.com/softspider)*  создаётся разработчиками для разработчиков.

Конечная цель *[SoftSpiders](https://github.com/softspider)* состоит в создании сервиса поддержки запуска программных проектов.
В основе проектакоторого . Стоит подчеркнуть - не сам сервис, а 
