...
из зоны комфорта. К запускам программных проектов это тоже относится, причём в самой полной мере.
...
Для этого ему одновременно нужно быть реализованным сразу для нескольких платформ: для всех популярных мобильных и
...
При этом справедливости ради, конечно, нужно признать, что развитие технологий происходит и в области средств
производства программного обеспечения. Производить программный код "при прочих равных" сегодня существенно проще, чем
раньше. 

Разработчики со стажем, имеют возможность, сравнивая разные времена, отслеживать тенденции. Для них, очевидно, что
проблемы старта растут опережающими темпами, а путь через долину смерти программных проектов становится всё длиннее. 

И чем дальше, тем более жизненно важной и нужной становится возможность преодолевать этот опасный путь максимально
