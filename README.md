...
Проект *[Soft Spiders](https://github.com/softspider)* создаётся разработчиками для разработчиков. Его цель состоит в
...
Желание сделать что-то новое часто очень быстро угасает, когда разработчик сталкивается или даже просто представляет
себе перспективу долгого и трудного старта, когда только для того, чтобы новая программа просто хоть как-то заработала,
приходится тратить время и силы на изучение множества разных, часто не слишком интересных материалов и мелких деталей,
к тому же когда знание большей части из них в итоге может оказаться ненужным.
