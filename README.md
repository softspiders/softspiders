...
Этих трудностей множество и причины у них разные. Какие-то имеют субъективный, какие-то - объективный характер.
...
При этом справедливости ради, конечно, нужно признать, что средства разработки программ также постоянно
совершенствуются, развитие технологий их не обходит. И сегодня "при прочих равных" производить программный код
существенно проще, чем раньше. 
...
*Стартерами* называются небольшие лёгкие в установке и запуске проекты, имеющие определённый набор свойств (фич, "как
говорят у них").
