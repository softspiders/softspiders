...
От проекта, взятого в основу, зависит скорость и качество старта новой разработки..., от чего, в свою очередь, зависит... 
...
Во втором случае любая потеря работоспособности программы сразу говорит об ошибке, и особенно легко это выявляется, если
в проекте есть автотесты.
