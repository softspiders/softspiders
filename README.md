...
В основе *Soft Spiders* лежит **классификатор программных решений**, используемых для обучения и разработки в качестве
средств **быстрого прототипирования**, таких как  *стартеры*, *генераторы*, *шаблоны* и т.п.
