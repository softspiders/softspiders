...
***Стартерами** называются, как правило, небольшие, заведомо работоспособные, лёгкие в установке и запуске проекты,
имеющие чётко определённый набор свойств, предназначенные для использования в качестве основы для новых разработок*.

В принципе преимущества использования стартеров всем понятны, но всё-таки хотелось бы отметить одно, возможно наименее
очевидное.  

В любой разработке присутствуют ошибки. В каком-то смысле ошибки являются данностью процесса разработки, но данностью,
которую необходимо минимизировать, в чём, кстати, состоит, наверное одна из главных составляющих искусства разработчика.  
...
#### Стартеры бывают разные

От проекта, берущегося за основу, может зависет скорость и качество не только самого старта, но и дальнейшего хода всей
разработки.
