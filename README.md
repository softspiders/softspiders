...
Конечная цель проекта *[SoftSpiders](https://github.com/softspider)* состоит в создании инструментов сервиса поддержки запуска
программных проектов.  

*SoftSpiders* создаётся разработчиками для разработчиков. В его основе лежит *классификатор стартеров* - 
