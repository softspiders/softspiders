...
программных решений**, который создаётся разработчиками для разработчиков.  

## Проблема старта 

Профессиональная жизнь разработчика включает в себя разные виды работ и складывается из разных периодов, среди которых
особую роль играют периоды старта новых проектов.
    
Новый проект это хоть в чём-то, но всегда новая жизнь. Даже в обстановке рабочей рутины он может стать точкой
профессионального роста, особенно, если такая цель ставится его автором - самим разработчиком.

Но желание начать что-то новое часто очень быстро угасает, когда разработчик сталкивается с перспективой долгого и
трудного старта, когда только для того, чтобы новая программа просто хоть как-то заработала, приходится тратить время
...
Старт космического корабля и выход на орбиту - самый короткий из всех этапов полёта. Вместе с тем он всегда был и
остаётся также наиболее сложным, ответственным и опасным.  
Но после того, как аппарат оказывается на орбите, полёт входит в стабильную фазу, а аппарат - в своё основное рабочее
состояние. Управление и поддержка конечно тоже требуется, главные проблемы уже позади и уровень опасности намного меньше.

...

Так и у программных проектов.
