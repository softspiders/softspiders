...
В таких случаях бывает большой удачей, если находится работающий проект с нужными свойствами, в котором все необходимые
рутинные этапы кем-то за тебя уже были пройдены.
