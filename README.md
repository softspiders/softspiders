...
зоны комфорта. К запускам программных проектов это тоже относится, причём в самой полной мере.

С течением времени трудности запуска любого на что-то претендующего проекта, хоть личного, хоть корпоративного,
постоянно возрастают. И в совокупности они создают серьёзную проблему стартового периода, который без особых
преувеличений можно считать долиной смерти программных проектов.

![](images/death-valley.jpg)

Этих трудностей множество и причины их разные. Какие-то имеют субъективный, какие-то - объективный характер.

Перечислим кратко самые очевидные.
...
материалов и мелких деталей. К тому же когда знание большей части из этих деталей в итоге может оказаться ненужным хотя
...
был принят пользователями, было достаточно выпустить его дистрибутив для десктопа на доступных для того времени
носителях (дискеты, CD, DVD).    
А сегодня для того, чтобы всё тот же календарь мог стать минимально конкурентоспособным и получил шансы "взлететь", от
него требуется намного больше: продукт должен быть доступен в режиме 24/7 и самое главное везде - на работе, дома,
в отпуске, в любом транспорте.  
Чтобы этого достичь, он должен быть реализован сразу для нескольких платформ: для всех популярных мобильных и десктопных
браузеров, иногда в виде их расширений, для смартфонов разных моделей и операционных систем,а в каких-то случаях и в
качестве нативных десктоп-приложений, хотя как раз этот вариант сейчас становится всё менее востребованным.  

При этом справедливости ради, конечно, нужно признать, что средства разработки программ тоже совершенствуются, развитие
технологий их тоже не обходит. И сегодня "при прочих равных" производить программный код существенно проще, чем раньше. 

Но разработчики со стажем, как, например, автор этих строк, сравнивая разные времена, могут зримо отслеживать тенденции 
и делать очевидные выводы: проблемы старта растут всё же опережающими темпами, а путь через долину смерти программных проектов
становится всё длиннее. 

Поэтому чем дальше, тем более жизненно важной и нужной становится возможность преодолевать этот опасный путь максимально
быстро, безопасно, с наименьшими затратами, сохраняя необходимые силы и мотивацию для дальнейшей работы в главном, уже
гораздо более стабильном рабочем периоде существования проекта.

И в этом преодолении серьёзную помощь разработчику могут оказать качественные *стартеры*.
