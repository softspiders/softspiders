...
Но разработчики со стажем, те, что видели дискеты или даже перфокарты, ощущая тенденции на себе, могут сравнивать
времена и делать очевидные выводы: при всех несомненных достижениях в сфере разработки программ проблемы старта растут
всё же опережающими темпами, и путь через долину смерти программных проектов пока становится только длиннее.
...
Чем на более раннем этапе находится разработка, тем больше риск потерпеть неудачу и, соответственно, потерять то, что в
...
Но каждый раз действует правило **минимально достаточного вложения сил**, при котором затраты на разработку должны быть
...
программными или иными инструментами, он проверяет, стоит ли этим заниматься в принципе.        
...
Прототип создаётся для того, чтобы продемонстрировать идею и приципиальную возможность её реализации какому-то, как
правило, не очень широкому кругу заинтересованных лиц, от которых может зависеть дальнейшая судьба проекта.  
Обычно к таким лицам относятся потенциальные участники разработки, спонсоры, инвесторы, а если проект предполагается
вести в рамках существующей компании, это может быть кто-то из руководства, из тех, кто "даёт добро".
