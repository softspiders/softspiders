...
Преимущества использования стартеров достаточно понятны, но всё-таки хотелось бы отметить одно, возможно наименее
очевидное.  

В любой разработке присутствуют ошибки, без ни не бывает, это данность. Вместе с тем их число необходимо минимизировать.    
И Дело в том, что ошибки, совершающиеся на этапе доведения проекта до минимально рабочего состояния - на том самом пути по
"долине смерти" - выявляются гораздо труднее, чем ошибки, которые делаются на уже работающем проекте, когда почти любая
потеря работоспособности программы становится сразу видна, особенно, если в ней присутствуют автотесты.

Стартеры это как раз такие "уже работающие проекты".
