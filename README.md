...
Чем на более раннем этапе находится разработка, тем больше риск потерпеть неудачу и, соответственно, тем больше риск
потерять то, что в эту разработку было вложено.

Известным подходом к оптимизации затрат, о котором часто упоминается в рассказах о стартапах (наверное потому, что о
стартапах вообще больше говорят), является разделение разработки на этапы: *проверка концепции* - *Proof of Concept
(PoC)*, создание *прототипа*, получение *минимально жизнеспособного продукта* - *Minimum Viable Product (MVP)*.  
