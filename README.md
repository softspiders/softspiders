...
Но сегодня для того, чтобы всё тот же календарь получил шансы "взлететь", от него требуется намного больше: он должен
быть доступен в режиме 24/7, а самое главное - везде: на работе, дома, в отпуске, в любом транспорте.     
