...
Разработчики со стажем, те, кто ещё видели дискеты, может быть даже и перфокарты, сравнивая разные времена, могут зримо
...
Поэтому всё более актуальными становятся поиски путей решения проблем стартового периода, возможностей преодолевать его
максимально быстро, безопасно, с наименьшими затратами, сохраняя необходимые силы и мотивацию для дальнейшей работы уже
на других, гораздо более стабильных, периодах существования проекта.

TBD

#### Проверка концепции

Доказать самому себе, что этим стоит заниматься.
TBD

#### Прототипы

Прототипы создаются для того, чтобы **минимальными средствами** продемонстрировать идею и приципиальную возможность её
реализации какому-то, как правило, не очень широкому кругу заинтересованных лиц, от которых может зависеть дальнейшая
судьба разработки. Обычно к таким лицам относятся потенциальные участники разработки, спонсоры, инвесторы, а если проект
предполагается вести в рамках существующей компании, то руководители соответствующих направлений.
