...
Если раньше для того, чтобы функционально полезный продукт (здесь говорим только о таких) был принят пользователями,
было достаточно выпустить работающее приложение для десктопа с дистрибутивом на доступных для того времени носителях
(дискеты, CD, DVD).  

Сегодня, для того, чтобы продукт, как говорится, "взлетел", этого мало. 
