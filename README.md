...
Профессиональная жизнь разработчика обычно складывается из самых разных периодов, среди которых особую, а иногда и
судьбоносную для него роль играют периоды начала новых проектов.    
Новый проект это хоть в чём-то, но всегда новая жизнь. Даже в обстановке рабочей рутины новый проект может стать точкой
профессионального роста, особенно, если такая цель ставится его автором.

### Самое трудное - начать

Но ничто так не убивает желание начать новую разработку, как перспектива долгого и трудного старта, когда только для
того, чтобы новая программа просто начала работать, приходится потратить уйму времени на изучение большого объёма обычно
не очень интересных материалов, множества разнообразных мелких деталей, к тому же знание о которых по множеству причин в
итоге может оказаться ненужным.

### Работающий проект - лучший старт

В таких случаях бывает большой удачей, если находится работающий проект, обладающий нужными свойствами, в котором все
необходимые рутинные этапы кем-то за тебя уже были пройдены.

Почему очень важно начинать разработку не с нуля, а именно с **уже работающего проекта** ?  
Потому, что ошибки, делающиеся на этапе доведения проекта до минимально рабочего состояния, выявляются гораздо труднее, 
чем ошибочные шаги делающиеся тогда, когда проект уже работает. Поскольку во втором случае любая потеря
работоспособности программы, сразу говорит об ошибке, что особенно легко выявляется при наличии автотестов.  
Кстати, с этим связано и одно из главных преимуществ TDD, поскольку при TDD разрабатываемая программа является
работоспособной и тестируемой с самого начала. 
