...
Проект *[SoftSpiders](https://github.com/softspider)* создаётся разработчиками для разработчиков, его цель состоит в
подготовке инструментальной базы, необходимой для обеспечения удобного и безболезненного запуска новых программных
проектов.    

В основе проекта лежит классификатор так называемых *стартеров* - в
...
Но начало чего-то по-настоящему нового, пусть даже новизна будет касаться только себя одного, всегда и неизбежно
связано с выходом из зоны комфорта. И к запускам программных проектов это правило относится в самой полной мере.

### Субъективное

Желание сделать что-то новое часто очень быстро угасает, когда разработчик сталкивается с перспективой долгого и
трудного старта, во многом требующего преодоления себя, когда только для того, чтобы новая программа просто хоть как-то
...
![rocket-explosion](images/death-valley.jpg)
...
Но с течением времени затраты, необходимые для запуска проекта (любого, хоть корпоративного, хоть личного), постоянно
возрастают.

Чем дальше развиваются технологии, тем больше требований предъявляется к программным продуктам, тем путь по всё той же
...
Стартеры обеспечивают быстрый старт.
