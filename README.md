...
Если кратко, *[SoftSpiders](https://github.com/softspider)* можно охарактеризовать как проект создания сервиса, 
ориентированного на поддержку запуска программных проектов.  
