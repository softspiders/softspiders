...
Чем более ранний этап у разработки, тем больше риск неудачи и, соответственно, тем больше риск потерять то, что в проект
было вложено.
...
Главным принципом каждого этапа запуска проекта, как и всего подхода в целом, будет **минимально достаточное вложение
сил**.
