...
Поиски путей решения проблем стартового периода становятся всё более актуальными. Нужны подходы, технологии,
инструменты, позволяющие преодолевать этот период максимально быстро, безопасно, с наименьшими затратами для того, чтобы
сохранить необходимые силы и мотивацию для дальнейшей работы уже на других, гораздо более стабильных, периодах
существования проекта.

На этапе становления проекта очень важно правильно распределить имеющиеся силы и средства.

Известным подходом к оптимизации затрат, который часто применяется в стартапах, является разделение разработки на этапы:
*проверка концепции* - *Proof of Concept (PoC)*, *прототипирование*, получение *минимально жизнеспособного продукта* -
*Minimum Viable Product (MVP)*. 

#### Проверка концепции

Минимальное вложение сил.
Проверка идеи.
На этом этапе часто проверяется производительность и ресурсозатратность проектируемого приложения или системы.
TBD  
