...
В основе *Soft Spiders* лежит **классификатор программных решений**, используемых в качестве средств **быстрого
прототипирования**, таких как  *стартеры*, *генераторы*, *шаблоны* и т.п.
...
Но никакое начинание не обходится без хотя бы некоторого преодоления себя, без выхода, как это сегодня принято говорить,
из зоны комфорта. И к запускам программных проектов это относится в самой полной мере.

Желание сделать что-то новое часто очень быстро угасает, когда разработчик сталкивается, может быть даже только в своём
воображении, с перспективой долгого и трудного старта, когда только для того, чтобы новая программа просто хоть как-то
заработала, приходится тратить время и силы на изучение множества разных, часто не слишком интересных материалов и
мелких деталей. К тому же когда знание большей части из этих деталей в итоге может оказаться ненужным, хотя бы из-за
изменений набора используемых инструменов, что на старте проекта является обычным делом.

Но, кроме субъективно-психологических трудностей запуска новых проектов, существуют объективные.  
Чем дальше программные технологии развиваются, тем больше требований предъявляется к программным продуктам.  

Пару-тройку десятков лет назад для того, чтобы функционально полезный программный продукт, к примеру, личный календарь,
был принят пользователями, было достаточно выпустить его для десктопа с дистрибутивом на доступных для того времени
носителях (дискеты, CD, DVD).  

А сегодня, для того, чтобы тот же календарь был минимально конкурентоспособен, имел шансы, как говорится, "взлететь",
нужно уже намного больше. Продукт должен быть доступен в режиме 24/7 и везде: на работе, дома, в отпуске, в любом транспорте.  
Это         

Поэтому с течением времени затраты, необходимые для запуска проекта - любого, хоть корпоративного, хоть личного - постоянно
возрастают.

В совокупности все эти трудности создают проблему периода старта, которую без особых преувеличений можно назвать долиной
смерти программных проектов.

![](images/death-valley.jpg)


, тем путь по всё той же
"долине смерти" становится более трудным.
...


Крайне желательно преодолеть эту долину побыстрее, в идеале - на одном дыхании, не потеряв драгоценного времени и
сохранив необходимую мотивацию.

Здесь хорошо подходит аналогия с полётом в космос.

Старт и выход космического корабля на орбиту - самый короткий из всех этапов полёта. Но при этом он самый сложный,
ответственный и опасный.  

![rocket-explosion](images/rocket-explosion.png)

После того, как аппарат оказывается на орбите, полёт входит в стабильную фазу, а аппарат - в своё главное рабочее
состояние. Управление и поддержка при этом, конечно, тоже нужны, но главные проблемы позади и уровень опасности намного
меньше.

Так и с программными проектами.  

Программные проекты становятся сложнее.
Время идёт, технологии усложняются, орбиты рабочих режимов поднимаются всё выше, соответственно и стартовых условий
становится всё больше.
Если раньше для старта было достаточно ...
Сегодня для того приложению или сервису успешно стартовать поддержка одного только web-интерфейса может оказаться уже
недостаточным.

При отсутствии надёжного "разгонного блока" риск не взлететь, 
 
### Стартеры

В таких случаях бывает большой удачей, если находится работающий и хорошо зарекомендовавший себя проект, имеющий все
нужные свойства, в котором все необходимые рутинные этапы становления кем-то ранее уже были пройдены.
В чём преимущества начала разработки не с нуля, а именно с **уже работающего проекта** ?  
Дело в том, что ошибки, делающиеся на этапе доведения проекта до минимально рабочего состояния, выявляются гораздо труднее, 
чем ошибочные шаги делающиеся на уже работающем проекте.  
Во втором случае любая потеря работоспособности программы сразу видна, особенно, если есть автотесты.

От проекта, берущегося в основу, как минимум, зависит скорость и качество старта новой разработки..., от чего, в свою
очередь, зависит...
