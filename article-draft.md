# *[Экспресс для долины смерти](https://github.com/softspider)*
...
1. [Долина смерти программных проектов](#долина-смерти-программных-проектов)
    ...
    2. [Объективное](#объективное) 
    3. [Пути преодоления](#пути-преодоления)
...
2. [Принципы организации](#принципы-организации)
...
7. [Текущее состояние проекта](#текущее-состояние-проекта)
    ...
    3. [Что будет нужно всегда](#что-будет-нужно-всегда) 
...
С течением времени трудности запуска любого на что-то претендующего проекта возрастают. И в совокупности они создают
серьёзную проблему стартового периода, который без особых преувеличений можно считать долиной смерти программных
проектов.

![](images/death-valley.jpg)


Образ долины смерти часто используется в рассказах о стартапах, где проблемы старта проявляются наиболее драматичным
образом, поскольку в каждом случае от их преодоления напрямую зависит выживание какого-то бизнес-проекта.  
  
Но эти проблемы характерны не только для стартапов. Они присутствуют и в личных, и в корпоративных проектах, в той или
иной степени с ними сталкиваются все разработчики без исключения.
...
Помимо субъективно-психологических трудностей старта, существуют и разнообразные объективные.  
...
состояния, выявляются гораздо труднее, чем те, что делаются на стабильной фазе разработки, особенно, когда есть
автотесты.

#### Опережающий рост проблем
...
Чем на более раннем этапе находится разработка, тем больше риск потерпеть неудачу и потерять всё, что в эту разработку
было вложено.
...
Взять за основу уже работающий проект

Как было сказано выше, на работающем проекте ошибки выявляются проще

Проект, берущийся за основу, подобен фундаменту при закладке дома ...  
Он может определить ход не только начального этапа работ, но и всей последующей разработки.    
Например, присутствие в проекте-основе автотестов стимулирует разработчиков писать автотесты, его скрипты сборки
предполагают использование разработчиками соответствующих инструментов, заложенные архитектурные решения накладывают
часто неизгладимый отпечаток на архитектуру нового проекта.
 
в проекте шаблоны проектирования - использование в проекте
соответствующих архитектурных решений и т.д.

### Стартеры

Последнее время нарождается новая категория проектов, называемых ***-стартерами***, спрос на которые постоянно растёт,
со временем они всё больше приобретают вид самостоятельных продуктов. 
...
Для того, чтобы со стартерами было удобно работать, они должны иметь чётко определённый набор свойств.
...
## Чего не хватает в Google ?

TBD

## Чего не хватает в GitHub ?
